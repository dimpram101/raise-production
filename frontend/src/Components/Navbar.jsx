        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-64 ">
          ...
          <div className="flex md:order-2">
            ...
            {/* <ul className="flex flex-row space-x-8">
              ...
              <li>
                <button type="button" onClick={() => navigate('/register')} className="text-white bg-[#ECB365] hover:bg-[#e19f42] focus:ring-4 focus:outline-none focus:ring-[#ECB365] font-medium rounded-md text-[16px] px-2 py-2 text-center font-poppins mr-3 md:mr-0 ">Daftar</button>
              </li>
            </ul> */}
            <div className="mt-[20px]  h-16" onMouseOver={props.DropdownShowUp} onMouseLeave={props.DropdownHidden}>
              <a href="#" >
          ...
          <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul className="flex flex-col p-4 md:p-0 mt-4  font-medium font-poppins bg-[#073054]  md:flex-row md:space-x-8 md:mt-0  ">
              <li>
                <button>
                  <a href="/" onClick={() => ('/')} className="nav" aria-current="page">Beranda</a>
                </button>
              </li>
              <li>
                <button>
                  <a  onClick={props.pushButtonAboutUs} className="nav">Tentang Kami</a>
                </button>
              </li>
              <li>
                <button>
                  <a  onClick={props.pushButtonService} className="nav">Layanan</a>
                </button>
              </li>
              <li>
                <button>
                  <a  onClick={props.pushButtonContact} className="nav">Kontak Kami</a>
                </button>
              </li>
            </ul>
          </div>
