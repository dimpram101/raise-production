const Gallery = () => {
    return (
        <div>
            <div className="flex justify-center bg-[#0c4475] mt-16 ml-20 mr-20 h-44 rounded-lg drop-shadow-lg">
                <h1 className="mt-10 text-[#ECB365] font-serif font-semibold drop-shadow-lg text-4xl text-center">
                        Gallery Raise Production
                        <p className="text-small text-white">
                            Gallery ini merupakan portofolio dari kami, terlepas dari adanya copyright dalam konten itu karena pihak yang berkaitan hanya ingin menggunakannya sebagai konsumsi pribadi.
                        </p>
                </h1>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 justify-center">
                <div className="grid gap-4 mt-10 ml-2 mr-2 mt-24 mb-2 justify-center">
                    <a className="justify-center text-white text-center font-semibold hover:text-blue-500 hover:italic hover:scale-105  duration-300">
                        <img class="h-auto max-w-full rounded-lg" src="./assets/gallery/Foto 1.jpg" alt=""/>
                    </a>
                    <a className="text-white text-center font-semibold hover:text-blue-500 hover:italic hover:scale-105  duration-300">
