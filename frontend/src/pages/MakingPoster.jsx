...
const MakingPoster = () => {
  ...
  const handlingPlusLotsOfPicture = () => {
    ...
    setLotOfPicturePrice(
      (prefPrice) => (prefPrice = 25000 * (lotsOfPicture + 1))
    );
  };
  ...
  const handlingMinusLotsOfPicture = () => {
    if (lotsOfPicture > 0) {
      ...
      setLotOfPicturePrice(() => lotsOfPicturePrice - 25000);
    }
  };
          ...
          <div className="text-[72px] text-white font-[900] flex flex-col items-center">
            <div className="flex">
              <div className=" bg-[#ECB365] p-1 rounded-lg shadow-sm">
                <img src="./assets/icon/ICON POSTER.png" alt="" />
              </div>

              <div className="ml-8">
                <h1>
                  Pembuatan <span className="text-[#ECB365] ">Poster</span>{" "}
                </h1>
              </div>
            </div>
          </div>
                    ...
                    <div className="flex items-center mb-4 mt-2">
                      ...
                      <div className="flex flex-row ml-3 text-white">
                        <div className="">
                          <button
                            type="button"
                            onClick={() => handlingMinusLotsOfPicture()}
                            className=""
                          >
                            -
                          </button>
                        ...
                        <div>
                          <button
                            onClick={() => handlingPlusLotsOfPicture()}
                            type="button"
                          >
                            +
                          </button>
