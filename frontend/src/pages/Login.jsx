      ...
      <div className="bg-[#073054] h-screen flex flex-col justify-center">
        <div className="flex flex-col mx-auto p-10 bg-[#04293A] h-[576px] w-[544px] shadow-2xl border-2 border-[#ECB365]">
          <div className="font-poppins flex flex-col items-center">
            ...
            <form className="pt-6">
              <div className="mb-6">
                <label htmlFor="email" className="block mb-2 text-[24px]  text-[#ECB365] dark:text-white">Email</label>
            ...
            <div>
              ...
              <div className="pt-3">
                <label htmlFor="daftar_button" className="block mb-2  text-[16px]  text-[#ECB365]">Belum mempunyai akun ? </label>
