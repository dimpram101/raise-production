    ...
    <>
      ...
      <div className="ml-64">
        <div className="flex flex-row justify-center items-center gap-10 h-screen">
          <div className="w-96 h-[440px] bg-[#04293A] flex flex-col gap-10 items-center justify-around py-8 font-poppins shadow-xl rounded-sm cursor-pointer" onClick={() => onClickRedirect('/dashboard/riwayat-pesanan')}>
          ...
          <div className="w-96 h-[440px] bg-[#04293A] flex flex-col gap-10 items-center justify-around py-8 font-poppins shadow-xl rounded-sm cursor-pointer" onClick={() => onClickRedirect('/dashboard/pesanan-pelanggan')}> 
